...
var NegociacaoController = function () {
  function NegociacaoController() {
    ...
    this._ordemAtual = '';
    this._listaNegociacoes = new Bind(new ListaNegociacoes(), new NegociacoesView($('#tabelaNegociacoes')), 'adiciona', 'esvazia', 'ordena', 'inverteOrdem');

    this._mensagem = new Bind(new Mensagem(), new MensagemView($('#mensagemAlerta')), 'texto');
  ...
  _createClass(NegociacaoController, [{
    ...
    key: '_carregarNegociacoes',
    value: function _carregarNegociacoes() {
      var _this3 = this;
    ...
    value: function _importaNegociacoes() {
      ...
      this._service.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
        ...
        _this5._mensagem.texto = 'Negociacões importadas com sucesso';
      }).catch(function (erro) {
